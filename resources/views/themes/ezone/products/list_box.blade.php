        ...
        <div class="product-content-list">
            ...
            <div class="product-list-cart-wishlist">
                <div class="product-list-cart">
                    <a class="btn-hover list-btn-style add-to-card" href="" product-id="{{ $product->id_barang }}"
                       {{--  product-type="{{ $product->jenis->jenis }}" product-slug="{{ $product->slug }}" --}}>add to cart</a>
                </div>
                <div class="product-list-wishlist">
                    <a class="btn-hover list-btn-wishlist add-to-fav" title="Favorite"
