...
<footer class="footer-area">
    <div class="footer-top-area pt-70 pb-35 wrapper-padding-5 border-top-3">
        <div class="container-fluid">
            <div class="widget-wrapper">
                ...
                <div class="footer-widget mb-30">
                        ...
                        <div class="content__social" style="align-content: center">
                            <a href="{{ env('INSTAGRAM_LINK') }}" target="_blank" style="text-decoration: none">
                                <img src="{{asset('storage/fb.png')}}" class="social-icon" width="50" />
                            </a>
                            <a href="{{ env('INSTAGRAM_LINK') }}" target="_blank" style="text-decoration: none">
                                <img src="{{asset('storage/ig.png')}}" class="social-icon" width="50" />
                            </a>
                        </div>
