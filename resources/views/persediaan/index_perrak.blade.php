...
<section class="content">
    <div class="card">
        <div class="card-header" style="background-color: #27c8f9">
        ...
        <div class="row row-cols-1 row-cols-md-3 flex-row">
            ...
            <div class="col-md-3 mb-4 px-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title"><a href="/persediaan/{{ $item->id_rak }}"> {{ $item->nomor_rak }}</a>
                        </h4>
                        <br>
                        <hr>
                        ...
                        <hr>
                        <div>
                            <a href="/persediaan/{{ $item->id_rak }}" class="btn btn-info btn-sm fa fa-list-alt"> Detail</a>
