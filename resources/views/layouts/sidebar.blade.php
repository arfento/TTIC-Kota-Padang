<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <a href="#"><i class="icon-transaksi"></i>Persediaan<span class="icon-expand"></span></a>
            ...
            <a href="#"><i class="icon-transaksi"></i>Transaksi<span class="icon-expand"></span></a>
            <ul class="nav-second-level" aria-expanded="false">
                ...
                <li class="active"><a href="{{ route('detailpenjualan.index') }}"><i class="fa fa-link"></i> <span>Detail Penjualan</span></a></li>
                        ...
                        <a href="#"><i class="icon-barang"></i>Barang<span class="icon-expand"></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                            <li>
                              <a href="{{ route('barang.index') }}"><i class="fa fa-link"></i> <span>Barang</span></a>
                            </li>
                            <li>
                              <a href="{{ route('jenisbarang.index') }}"><i class="fa fa-link"></i> <span>Jenis Barang</span></a>
                            </li>
                            <li>
                              <a href="{{ route('satuanpembelian.index') }}"><i class="fa fa-link"></i> <span>Satuan Pembelian</span></a>
                            </li>
                            <li>
                              <a href="{{ route('satuanpenjualan.index') }}"><i class="fa fa-link"></i> <span>Satuan Penjualan</span></a>
                            </li>
                            <li>
                              <a href="{{ route('supplier.index') }}"><i class="fa fa-link"></i> <span>Supplier</span></a>
                            </li>
                        </ul>
