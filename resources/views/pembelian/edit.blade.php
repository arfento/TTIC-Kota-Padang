                  ...
                  <tr>
                    <td>
                      <select class="form-control" name="barang_id[0]">
                        ...
                        <option value="{{ $item-> barang-> id_barang }}"> {{ $item-> barang -> nama_barang }} </option>
                        @endforeach
                      </select>
                    </td>
                    <td>
          ...
          function addRow()
          {
              ...
              '<td>'+
                '<select class="form-control" name="rak_id[' + index + ']">'+
                      ...
                      '</select>'+
              '</td>'+
              '<td><input type="text" name="jumlah[' + index + ']" class="form-control jumlah">'+
                '@foreach($pembelian-> detailPembelian as $itemp)'+
                      'value=" {{ $itemp->jumlah}}"'+
                                               
                      '@endforeach>'+
              '</td>'+
              '<td><input type="text" name="harga_satuan[' + index + ']" class="form-control harga_satuan">'+
                '@foreach($pembelian-> detailPembelian as $itemp)'+
                      'value=" {{ $itemp->harga_satuan}}"'+
