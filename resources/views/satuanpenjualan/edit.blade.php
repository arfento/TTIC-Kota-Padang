...
<section class="content">
  <div class="card">
    ...
    <div class="card-body">
      @include('validasi')
      <form action="{{ route('satuanpenjualan.update', $satuanpenjualan->id_satuan_penjualan) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <div class="col-md-6">
              <input type="text" name="satuan" class="form-control" value="{{ $satuanpenjualan->satuan }}">
            </div>
