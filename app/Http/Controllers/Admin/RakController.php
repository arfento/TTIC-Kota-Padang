...
class RakController extends Controller
{
    ...
    public function index()
    {
        ...
        //             }
        //         ]);
        return view('persediaanperrak',compact('raks'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('persediaanperrak')->with('success','Data Berhasil Dimasukkan');
        //
    ...
    public function update(Request $request, $rak)
    {
        ...
        return redirect()->route('persediaanperrak')->with('success','Data Berhasil Diupdate');
        //
    }
    ...
    public function destroy($id_rak)
    {
        ...
        // $id_rak->delete();
        Rak::destroy($id_rak);
        return redirect()->route('persediaanperrak')->with('success','Data Berhasil Dihapus');
        //
    }
}
