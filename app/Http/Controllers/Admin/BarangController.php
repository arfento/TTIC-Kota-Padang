...
class BarangController extends Controller
{
    ...
    public function create()
    {
        ...
        $satuanpembelian = SatuanPembelian::orderBy('satuan', 'asc')->get();
        $satuanpenjualan = SatuanPenjualan::orderBy('satuan', 'asc')->get();
        $jenisbarang = JenisBarang::orderBy('jenis', 'asc')->get();
        $barang = Barang::all();
        // $random = Str::random(5);
        $random = mt_rand(100000000, 999999999);
        // $random = uniqid();
        return view('barang.create', compact('satuanpembelian', 'satuanpenjualan', 'jenisbarang', 'random'));
    }
