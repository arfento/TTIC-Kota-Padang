...
class ProductController extends Controller
{
	...
	public function __construct()
	{
		...
		$this->data['jenisbarangs'] = JenisBarang::orderBy('jenis', 'asc')
			->get();

		$this->data['minPrice'] =  Barang::min('harga_jual');
		$this->data['maxPrice'] = Barang::max('harga_jual');
	...
	public function index(Request $request)
	{
		...
		// $this->data['barangs'] = $products::paginate(9);
		return view('themes.ezone.products.index', compact('products', 'jenisbarang'));
	}
	...
	public function show($id)
	{
		...
		$jenisbarang = JenisBarang::findOrFail($id)->barang()->orderBy('created_at', 'ASC')->paginate(12);;
		...
		return view('themes.ezone.products.show', compact('product','jenisbarang'));
	}
